...
// 1. first param should = spell or damage spell
// 2 if its a damage spell second param = spellcaster
// 3 return false if above conditions are not satisfied
// use instanceOf to check 

// 4 check if spellcaster has enough mana to cast spell
// 5 if it does; mana -= cost;
// 6 if mana is less then < cost return false

// if there is enough mana to cast spell return true,
// if it is a DamageSpell reduce targer health spells damage value


// use inflictDamage , spend mana
